<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="88px">
      <el-form-item label="辞書名称" prop="dictName">
        <el-input
          v-model="queryParams.dictName"
          placeholder="辞書名称を入力してください"
          clearable
          style="width: 240px"
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="辞書名称" align="center" prop="dictName" :show-overflow-tooltip="true" />
      <el-table-column label="辞書タイプ" align="center" :show-overflow-tooltip="true">
      ...
      <el-table-column label="状態" align="center" prop="status">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="辞書名称" prop="dictName">
          <el-input v-model="form.dictName" placeholder="辞書名称を入力してください" />
        </el-form-item>
        <el-form-item label="辞書タイプ" prop="dictType">
          <el-input v-model="form.dictType" placeholder="辞書タイプを入力してください" />
        </el-form-item>
        <el-form-item label="状態" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictName: [
          { required: true, message: "辞書名称は必須入力項目です", trigger: "blur" }
        ],
        dictType: [
          { required: true, message: "辞書タイプは必須入力項目です", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('辞書番号は"' + dictIds + '"のデータを削除しますか？').then(function() {
    ...
    handleRefreshCache() {
      refreshCache().then(() => {
        this.$modal.msgSuccess("リフレッシュ成功しました");
